...
describe("Button Component", () => {
  it("renders button with label", () => {
    render(<Button style={["primary"]} label="Test Button" />);
  ...
  it("applies correct base class when style prop is an empty array", () => {
    render(<Button style={[]} label="Base Button" />);
  ...
  it("applies correct CSS classes based on style prop", () => {
    render(
      <Button
        style={["primary", "secondary", "inline", "logo", "tool"]}
        label="Styled Button"
      />
    );
  ...
  it("renders as NavLink when 'to' prop is provided", () => {
    render(<Button style={["primary"]} label="Navigate" to="/test" />);
